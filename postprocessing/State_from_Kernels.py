...
#parser
parser = argparse.ArgumentParser(description='transform a KERNELS file into a STATE file, so that it can be used with FES_from_State.py DO NOT use the obtained STATE file for restart')
